async function subscribe() {
    let subscription = await makeSubscription();
...
async function actualizePushNotifierStatus() {
    if(!canUseNotificationPush()) {
        return;
    }
...
function canUseNotificationPush() {
    if(notificationsAreSupported() && pushServiceIsSupported()) {
        return !notificationsAreDisallowedByUser();
    }
    return false;
}
